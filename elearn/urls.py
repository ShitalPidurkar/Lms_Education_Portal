...
urlpatterns = [
    ...
    path('quiz_change/<int:pk>', views.QuizUpateView.as_view(), name='quiz_change'),
    ...
    path('quiz/<int:quiz_pk>/int:question/<int:question_pk>/delete/', views.QuestionDeleteView.as_view(), name='question_delete'),
